  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="py-24 bg-slate-50/50 border-y border-slate-100">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-medium text-slate-900 mb-4">{t.servicePage.diffTitle}</h2>
              <p className="text-slate-500 font-light">{t.servicePage.diffSubtitle}</p>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
           <div className="flex flex-col lg:flex-row gap-16 items-start">
              <div className="lg:w-1/3 lg:sticky lg:top-32">
                  <h2 className="text-3xl font-medium text-slate-900 mb-6 leading-tight">{t.servicePage.advantagesTitle}</h2>
                  <p className="text-slate-500 font-light leading-relaxed mb-8">
                    {t.servicePage.advantagesDesc}
                  </p>
      ...
      <section className="py-32 bg-[#020408] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <h2 className="text-3xl font-medium text-center mb-24 text-white">{t.servicePage.methodologyTitle}</h2>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="rounded-[3rem] bg-gradient-to-br from-blue-50 to-white border border-blue-100/50 p-10 sm:p-20 text-center relative overflow-hidden mb-24 shadow-sm">
             ...
             <div className="relative z-10 max-w-3xl mx-auto">
                 ...
                 <h2 className="text-2xl font-bold mb-8 text-slate-900">{t.servicePage.guaranteeTitle}</h2>
          ...
          <div className="max-w-3xl mx-auto">
             <h2 className="text-2xl font-medium text-center mb-12 text-slate-900">{t.servicePage.faqTitle}</h2>
