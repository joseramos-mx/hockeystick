...
import { Play, Target, Users, Zap, Award } from "lucide-react"
...
export default function AboutPage() {
  ...
  const pillars = [
    {
        icon: Zap,
        title: t.about.pillars.agileTitle,
        desc: t.about.pillars.agileDesc
    },
    {
        icon: Award,
        title: t.about.pillars.certTitle,
        desc: t.about.pillars.certDesc
    },
    {
        icon: Target,
        title: t.about.pillars.resultsTitle,
        desc: t.about.pillars.resultsDesc
    }
  ]
        ...
        <div className="container mx-auto px-6 lg:px-12 mb-24 lg:mb-32">
          <div className="max-w-5xl mx-auto text-center lg:text-left">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] font-medium tracking-tight text-slate-900 mb-8 leading-[1.05]">
              {t.about.titlePart1} <br className="hidden sm:block" />
                ...
                <div className="lg:col-span-5 order-2 lg:order-1">
                    <div className="grid grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div className="bg-slate-50 p-6 sm:p-8 rounded-[2rem] flex flex-col items-start justify-between aspect-square transition-all hover:bg-white hover:shadow-lg hover:shadow-slate-200/40 border border-transparent hover:border-slate-100">
                            ...
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-auto whitespace-pre-line">
                              {t.about.stats.years}
                            </span>
                        </div>
                        {/* Stat 2 */}
                        <div className="bg-[#020408] p-6 sm:p-8 rounded-[2rem] flex flex-col items-start justify-between aspect-square shadow-2xl text-white mt-8 lg:mt-12">
                            ...
                            <span className="text-xs font-bold text-white/60 uppercase tracking-widest mt-auto whitespace-pre-line">
                              {t.about.stats.roi}
                            </span>
                        </div>
                        {/* Stat 3 */}
                        ...
                        <div className="bg-blue-50 p-6 sm:p-8 rounded-[2rem] flex flex-col items-start justify-between aspect-square border border-blue-100">
                            ...
                            <span className="text-xs font-bold text-blue-600/60 uppercase tracking-widest mt-auto whitespace-pre-line">
                              {t.about.stats.mentors}
                            </span>
                        </div>
                    </div>
                </div>

                {/* Right: Narrative (TRADUCIDO) */}
        ...
        <section className="bg-slate-50/50 py-24 sm:py-32 border-y border-slate-100">
            <div className="container mx-auto px-6 lg:px-12">
                <div className="max-w-3xl mb-16">
                    <h2 className="text-3xl sm:text-4xl font-medium text-slate-900 mb-6">{t.about.pillarsTitle}</h2>
